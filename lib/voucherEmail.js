    ...
    <div style="max-width:480px;margin:0 auto;background:#ffffff;border-radius:12px;overflow:hidden;border:1px solid #e6dcd0;">
      ...
      <div style="padding:32px;">
        ...
        <p style="font-size:16px;line-height:1.5;margin:0 0 24px;">
          Ya tenés tu voucher para tu experiencia de <strong>${config.businessName}</strong> en nuestra ${config.fincaName}. Te dejamos el link para que hagas tu reserva.
        </p>
...
Ya tenés tu voucher para tu experiencia de ${config.businessName} en nuestra ${config.fincaName}.
